...
class Relation extends Base {
  ...
  getRelation(data, options = {}) {
    ...
    return _asyncToGenerator(function* () {
      ...
      let promises = Object.keys(_this.relation).map(function (key) {
        ...
        let model = _this.findModel(item.model || key).options(modelOpts);
  ...
  getRelationTableName(model) {
    let table = [this.tablePrefix, this.tableName || this.name, '_', model.getModelName()].join('');
  ...
  _postManyToManyRelation(data, mapOpts) {
    ...
    return _asyncToGenerator(function* () {
      ...
      let relationModel = mapOpts.rModel ? _this7.findModel(mapOpts.rModel) : _this7.getRelationModel(model);
